...
class productClass:
    def __init__(self,root):
        ...
        lbl_product_name=Label(product_Frame,text="Product_Name",font=("goudy old style",18),bg="white").place(x=30,y=160)
        ...
        txt_name=Entry(product_Frame,textvariable=self.var_name,font=("goudy old style",15),bg="lightyellow").place(x=180,y=160,width=200)
        txt_price=Entry(product_Frame,textvariable=self.var_price,font=("goudy old style",15),bg="lightyellow").place(x=180,y=210,width=200)
        txt_qty=Entry(product_Frame,textvariable=self.var_qty,font=("goudy old style",15),bg="lightyellow").place(x=180,y=260,width=200)
